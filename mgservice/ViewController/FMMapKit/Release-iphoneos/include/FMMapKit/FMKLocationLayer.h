 ...
 */
- (void)addLocationMarker:(FMKLocationMarker *)locationMarker;
 ...
 *  @param locationMarker 定位标注点
 */
- (void)removeLocateMark:(FMKLocationMarker *)locationMarker;

/**
 *  删除所有定位标注
 */
- (void)removeAllLocateMark;
